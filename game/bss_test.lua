...
local jptoggle = miscc:CreateToggle("Jump Power", nil, function(State) Window:Toggle(State) kocmoc.toggles.loopjump = State end) jptoggle:CreateKeybind("L", function(Key) end) jptoggle:SetState(true)
...
local walkspeedoption = farmsettings:CreateSlider("Walk Speed", 0, 150, 70, false, function(Value) kocmoc.vars.walkspeed = Value end) 
local jumppoweroption = farmsettings:CreateSlider("Jump Power", 0, 150, 70, false, function(Value) kocmoc.vars.jumppower = Value end) 
