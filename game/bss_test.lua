...
local jptoggle = miscc:CreateToggle("Jump Power", nil, function(State) Window:Toggle(State) kocmoc.toggles.loopjump = State end) jptoggle:CreateKeybind("L", function(Key) end) jptoggle:SetState(ture)
