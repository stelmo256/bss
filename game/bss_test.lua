...
information:CreateLabel("Modified by Stelmo256")
...
local wstoggle = miscc:CreateToggle("Walk Speed", nil, function(State) Window:Toggle(State) kocmoc.toggles.loopspeed = State end) wstoggle:CreateKeybind("K", function(Key) end) wstoggle:SetState(true)
local jptoggle = miscc:CreateToggle("Jump Power", nil, function(State) kocmoc.toggles.loopjump = State end) jptoggle:CreateKeybind("L", function(Key) end) jptoggle:SetState(ture)
...
local walkspeedoption = farmsettings:CreateSlider("Walk Speed", 0, 150, 70, false, function(Value) kocmoc.vars.walkspeed = Value end) walkspeedoption:SetOption(150)
local jumppoweroption = farmsettings:CreateSlider("Jump Power", 0, 150, 70, false, function(Value) kocmoc.vars.jumppower = Value end) jumppoweroption:SetOption(150)
