...
dispsettings:CreateToggle("Royal Jelly Dispenser", nil, function(State) kocmoc.dispensesettings.rj = not kocmoc.dispensesettings.rj end) local rj = kocmoc.dispensesettings.rj rj:SetState(true)
