...
farmo:CreateToggle("Autodig", nil, function(State) Window:Toggle(State) kocmoc.toggles.autodig = State end)
...
farmo:CreateToggle("Farm Precise Crosshairs", nil, function(State) Window:Toggle(State) kocmoc.toggles.collectcrosshairs = State end)
...
farmt:CreateToggle("Auto Field Boosters [⚙]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autoboosters = State end)
farmt:CreateToggle("Auto Wealth Clock", nil, function(State) Window:Toggle(State) kocmoc.toggles.clock = State end)
farmt:CreateToggle("Auto Gingerbread Bears [B]", nil, Window:Toggle(State) function(State) kocmoc.toggles.collectgingerbreads = State end)
farmt:CreateToggle("Auto Samovar [B]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autosamovar = State end)
farmt:CreateToggle("Auto Stockings [B]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autostockings = State end)
farmt:CreateToggle("Auto Planters", nil, function(State) Window:Toggle(State) kocmoc.toggles.autoplanters = State end):AddToolTip("Will re-plant your planters after converting, if they hit 100%")
farmt:CreateToggle("Auto Honey Candles [B]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autocandles = State end)
farmt:CreateToggle("Auto Beesmas Feast [B]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autofeast = State end)
farmt:CreateToggle("Auto Onett's Lid Art [B]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autoonettart = State end)
farmt:CreateToggle("Auto Free Antpasses", nil, function(State) Window:Toggle(State) kocmoc.toggles.freeantpass = State end)
farmt:CreateToggle("Farm Sprouts", nil, function(State) Window:Toggle(State) kocmoc.toggles.farmsprouts = State end)
...
farmt:CreateToggle("Auto Accept/Confirm Quests [⚙]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autoquest = State end)
farmt:CreateToggle("Auto Do Quests [⚙]", nil, function(State) Window:Toggle(State) kocmoc.toggles.autodoquest = State end)
farmt:CreateToggle("Auto Honeystorm", nil, function(State) Window:Toggle(State) kocmoc.toggles.honeystorm = State end)
farmt:CreateLabel(" ")
...
mobkill:CreateToggle("Kill Vicious", nil, function(State) Window:Toggle(State) kocmoc.toggles.killvicious = State end)
mobkill:CreateToggle("Kill Windy", nil, function(State) Window:Toggle(State) kocmoc.toggles.killwindy = State end)
...
local wstoggle = miscc:CreateToggle("Walk Speed", nil, function(State) Window:Toggle(State) kocmoc.toggles.loopspeed = State end) wstoggle:CreateKeybind("K", function(Key) end)
local jptoggle = miscc:CreateToggle("Jump Power", nil, function(State) Window:Toggle(State) kocmoc.toggles.loopjump = State end) jptoggle:CreateKeybind("L", function(Key) end)
...
farmsettings:CreateToggle("Convert Hive Balloon",nil, function(State) Window:Toggle(State) kocmoc.toggles.convertballoons = State end)
...
farmsettings:CreateSlider("Walk Speed", 0, 150, 70, false, function(Value) kocmoc.vars.walkspeed = Value end)
farmsettings:CreateSlider("Jump Power", 0, 150, 70, false, function(Value) kocmoc.vars.jumppower = Value end)
...
dispsettings:CreateToggle("Royal Jelly Dispenser", nil, function(State) Window:Toggle(State) kocmoc.dispensesettings.rj = not kocmoc.dispensesettings.rj end)
dispsettings:CreateToggle("Blueberry Dispenser", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.blub = not kocmoc.dispensesettings.blub end)
dispsettings:CreateToggle("Strawberry Dispenser", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.straw = not kocmoc.dispensesettings.straw end)
dispsettings:CreateToggle("Treat Dispenser", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.treat = not kocmoc.dispensesettings.treat end)
dispsettings:CreateToggle("Coconut Dispenser", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.coconut = not kocmoc.dispensesettings.coconut end)
dispsettings:CreateToggle("Glue Dispenser", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.glue = not kocmoc.dispensesettings.glue end)
dispsettings:CreateToggle("Mountain Top Booster", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.white = not kocmoc.dispensesettings.white end)
dispsettings:CreateToggle("Blue Field Booster", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.blue = not kocmoc.dispensesettings.blue end)
dispsettings:CreateToggle("Red Field Booster", nil,  function(State) Window:Toggle(State) kocmoc.dispensesettings.red = not kocmoc.dispensesettings.red end)
